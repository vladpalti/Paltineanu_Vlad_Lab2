...
namespace Paltineanu_Vlad_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Paltineanu_Vlad_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Paltineanu_Vlad_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
